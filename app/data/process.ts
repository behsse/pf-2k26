/** The three steps of the working method shown on /service. Kept as data so the
 * animation code never has to care how many there are: the timeline, the
 * connector line and its markers are all derived from this array's length. */
export const PROCESS_STEPS = [
  ...
  },
  {
    ...
    body: "Design et code avancent ensemble, pas l'un après l'autre. Tu vois le projet vivre au fil de l'eau, dans le navigateur, et pas seulement en maquette figée.",
  },
  {
